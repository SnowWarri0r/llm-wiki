...
题 A 的 reward 为 `[1,1,0,0]`，正确回答的原 GRPO advantage 是 \((1- .5)/.5=1\)。题 B 为 `[1,0,0,0]`，正确回答是 \((1- .25)/.433\approx 1.732\)。除标准差以后，题 B 的这个正确样本天然被放大 73%。Dr.GRPO 分别得到 `.5` 和 `.75`，不再额外乘 `1/std`。
