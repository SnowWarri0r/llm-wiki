...
<svg viewBox="0 0 720 410" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;display:block;">
  ...
  <!-- 游走箭头：从孤岛掉进死区 -->
  <path d="M100,135 Q150,170 190,205" fill="none" stroke="#3a3128" stroke-width="1.4" stroke-dasharray="4 3"/>
  <polygon points="190,205 183,199 187,209" fill="#3a3128"/>
  ...
  <!-- 游走箭头：处处落点都有效 -->
  <path d="M485,200 Q530,235 575,210" fill="none" stroke="#9b2c2c" stroke-width="1.6" stroke-dasharray="4 3"/>
  <polygon points="575,210 567,207 570,217" fill="#9b2c2c"/>
