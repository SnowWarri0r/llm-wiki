...
<svg viewBox="0 0 720 220" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;display:block;font-family:JetBrains Mono,monospace;">
  <defs><marker id="gb-h" viewBox="0 0 10 10" refX="8" refY="5" markerWidth="7" markerHeight="7" orient="auto"><path d="M0,1 L9,5 L0,9 z" fill="#9b2c2c"/></marker></defs>
  <!-- loss 碗 -->
  <path class="draw d1" d="M70,40 C 250,40 250,180 360,180 C 470,180 470,40 650,40" fill="none" stroke="#3a3128" stroke-width="2" pathLength="1000"/>
  <text class="reveal d1" x="360" y="200" text-anchor="middle" font-size="9" fill="#7a6f5d">参数 w →</text>
  <text class="reveal d1" x="48" y="100" text-anchor="middle" font-size="9" fill="#7a6f5d" transform="rotate(-90 48 100)">loss</text>
  <!-- 当前点 + 负梯度步 -->
  <circle class="reveal d2" cx="160" cy="92" r="6" fill="#9b2c2c"/>
  <text class="reveal d2" x="160" y="80" text-anchor="middle" font-size="8" fill="#9b2c2c">现在 w</text>
  <line class="reveal d3" x1="172" y1="100" x2="250" y2="140" stroke="#9b2c2c" stroke-width="2" marker-end="url(#gb-h)"/>
  <text class="reveal d3" x="250" y="120" text-anchor="middle" font-size="8" fill="#9b2c2c">−lr·梯度 → 下坡一步</text>
  <circle class="reveal d4" cx="360" cy="180" r="6" fill="#1f4d3a"/>
  <text class="reveal d4" x="360" y="168" text-anchor="middle" font-size="8" fill="#1f4d3a">谷底 (loss 最小)</text>
  <text class="reveal d5" x="360" y="28" text-anchor="middle" font-family="Fraunces,serif" font-style="italic" font-size="11.5" font-weight="700" fill="#3a3128">梯度指上坡最陡 → 取负方向迈一小步 → 反复滚到谷底</text>
</svg>
</figure>
